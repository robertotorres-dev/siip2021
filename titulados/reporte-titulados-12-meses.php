  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Reporte de titulados en 12 meses</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
	      ...
	      {
                printf( "<option value='reporte-titulados-12-meses.php?id_ciclo=%d' selected='selected'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
	      else
	      {
                printf( "<option value='reporte-titulados-12-meses.php?id_ciclo=%d'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
            }
	  ?>
          </select>
	  ...
	  $max = count( $obj4->id_alumno );
          ...
          for( $i=0; $i<$max; $i++ )
          {
            $fecha_egresado = new DateTime( $obj4->fecha_egresado[$i] );
	    $fecha_titulado = new DateTime( $obj4->fecha_titulado[$i] );
	    $diferencia = $fecha_egresado->diff( $fecha_titulado );
	    $meses = ( $diferencia->y * 12 ) + $diferencia->m + ( $diferencia->d * .03333333 );
	...
	?>
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="consulta-titulados.php?id_alumno=<?php echo $obj4->id_alumno[$i]; ?>">
