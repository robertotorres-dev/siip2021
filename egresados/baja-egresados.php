...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="baja-egresados2.php" onsubmit="return confirmarBaja( )">
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Baja de egresados</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	  ...
	  <?php echo $obj2->apellido_paterno." ".$obj2->apellido_materno." ".$obj2->nombre; ?>
        ...
        <tr class="textoTablas1">
          <td colspan="4">DATOS DE EGRESO</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
