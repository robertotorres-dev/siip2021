<?php
  ...
  if( isset( $_GET["error"] ) ) 
  {
    ...
    switch( $error )
    {
      case 1: $msg_error = "El egresado ya se encuentra promocionado."; break;
    }
  }
  else
  {
...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="promocion-egresados3.php">
	  ...
	  <?php echo $obj2->apellido_paterno." ".$obj2->apellido_materno." ".$obj2->nombre; ?>
        ...
        <tr class="textoTitulos4">
          ...
          <td><input type="text" name="numero_acta" size="25" maxlength="20" required="required" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
