...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="alta-vinculaciones2.php" enctype="multipart/form-data">
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Alta de proyectos de vinculaci&oacute;n</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          <td colspan="2"><input type="text" name="responsable" size="50" maxlength="50" required="required" /></td>
          <td><input type="date" name="fecha" placeholder="aaaa-mm-dd" required="required" value="" style="width: 180px"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          <td colspan="2" valign="top"><textarea name="instancias" cols="50" rows="10" required="required"></textarea></td>
          <td colspan="2" valign="top"><textarea name="beneficios" cols="50" rows="10" required="required"></textarea></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
