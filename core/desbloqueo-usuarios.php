<?php
  ...
  $obj2 = new Usuarios( );
  $obj2->id_usuario = $_GET["id_usuario"];
  $obj2->obtenerUsuario( );
  ...
  $obj4 = new Perfiles( );
  $obj4->id_perfil = $obj2->id_perfil;
  $obj4->obtenerPerfil( );
  
  $obj5 = new Paises( );
  $obj5->id_pais = $obj2->id_pais;
  $obj5->obtenerPais( );
?>
...
{
  if( confirm( "¿Desea desbloquear el registro seleccionado?" ) )
  {
    return true;
  }
  else
...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="desbloqueo-usuarios2.php" onsubmit="return confirmarDesbloqueo( )">
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Desbloqueo de usuarios</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <input type="hidden" name="id_usuario" value="<?php echo $obj2->id_usuario; ?>" />
          </td>
        </tr>
        <tr>
          <td>&nbsp;</td>
