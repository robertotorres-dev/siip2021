...
<body>
  <table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr height="100%" valign="top">
      <td>
        <form id="form1" name="form1" method="post" action="baja-eventos2.php" onsubmit="return confirmarBaja( )">
          <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
            ...
            <tr class="textoTitulos2">
              <td colspan="4">Baja de eventos acad&eacute;micos organizados o en donde participa el programa</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
