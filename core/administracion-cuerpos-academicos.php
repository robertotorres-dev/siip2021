      ...
      <td>
        <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
          ...
          <tr class="textoTitulos4">
            <td colspan="3"></td>
            <td align="center"><input type="button" onclick="location.href='alta-cuerpos-academicos.php'" value="   Nuevo   " /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          ?>
            <tr class="textoTablas2">
              ...
              <td align="center" colspan="2">
                <a href="consulta-cuerpos-academicos.php?id_cuerpo_academico=<?php echo $obj2->id_cuerpo_academico[$i]; ?>">
                  <img src="../images/icon-search.png" width="16" height="16" /></a>
                <a href="edicion-cuerpos-academicos.php?id_cuerpo_academico=<?php echo $obj2->id_cuerpo_academico[$i]; ?>">
                  <img src="../images/icon-edit.png" width="16" height="16" /></a>
                <a href="baja-cuerpos-academicos.php?id_cuerpo_academico=<?php echo $obj2->id_cuerpo_academico[$i]; ?>">
          ...
          <tr class="textoTitulos4">
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td align="center"><input type="button" onclick="location.href='excel-cuerpos-academicos.php'" value=" Exportar Excel " /></td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
