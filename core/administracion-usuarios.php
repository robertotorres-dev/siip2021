    ...
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Administraci&oacute;n de usuarios</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          ...
          <td align="center"><input type="button" onclick="location.href='alta-usuarios.php'" value="   Nuevo   " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <?php
	  $max = count( $obj3->id_usuario );
          
          for( $i=0; $i<$max; $i++ )
          {
	    $obj4 = new Perfiles( );
            $obj4->id_perfil = $obj3->id_perfil[$i];
            $obj4->obtenerPerfil( );
	?>
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="consulta-usuarios.php?id_usuario=<?php echo $obj3->id_usuario[$i]; ?>">
          <img src="../images/icon-search.png" width="16" height="16" /></a>
          <a href="edicion-usuarios.php?id_usuario=<?php echo $obj3->id_usuario[$i]; ?>">
          <img src="../images/icon-edit.png" width="16" height="16" /></a>
          <a href="baja-usuarios.php?id_usuario=<?php echo $obj3->id_usuario[$i]; ?>">
