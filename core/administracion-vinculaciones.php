    ...
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos4">
          ...
          <td align="center"><input type="button" onclick="location.href='alta-vinculaciones.php'" value="   Nuevo   " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTablas1">
          <td>ID</td>
          <td>PROYECTO DE VINCULACI&Oacute;N</td>
          <td>RESPONSABLE</td>
          <td>ACCIONES</td>
        </tr>
        <?php
        ...
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="consulta-vinculaciones.php?id_vinculacion=<?php echo $obj3->id_vinculacion[$i]; ?>">
          <img src="../images/icon-search.png" width="16" height="16" /></a>
          <a href="edicion-vinculaciones.php?id_vinculacion=<?php echo $obj3->id_vinculacion[$i]; ?>">
          <img src="../images/icon-edit.png" width="16" height="16" /></a>
          <a href="baja-vinculaciones.php?id_vinculacion=<?php echo $obj3->id_vinculacion[$i]; ?>">
        ...
        <tr class="textoTitulos4">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td align="center"><input type="button" onclick="location.href='excel-vinculaciones.php'" value=" Exportar Excel " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
