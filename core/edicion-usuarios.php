<?php
  ...
  $obj3 = new Programas( );
  $obj3->id_programa = $_SESSION["id_programa"];
...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="edicion-usuarios2.php" enctype="multipart/form-data" onsubmit="return verificarContrasena( )">
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Edici&oacute;n de usuarios</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          ...
          <option value=''></option>
          <?php
            $max = count( $obj4->id_perfil );
            
            for( $i=0; $i<$max; $i++ )
            {
              if( $obj4->id_perfil[$i]==$obj2->id_perfil )
	      {
                printf( "<option value='%d' selected='selected'>%s</option>\n", $obj4->id_perfil[$i], $obj4->nombre[$i] );
	      }
	      else
	      {
