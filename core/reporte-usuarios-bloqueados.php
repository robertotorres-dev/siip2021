  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Reporte de usuarios bloqueados</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	...
	?>
        <tr class="textoTablas2">
          ...
          <td><?php echo $obj3->accesos_fallidos[$i]; ?>&nbsp;</td>
          <td align="center">
          <a href="desbloqueo-usuarios.php?id_usuario=<?php echo $obj3->id_usuario[$i]; ?>">
