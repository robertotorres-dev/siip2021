    ...
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos4">
          ...
          <td align="center"><input type="button" onclick="location.href='alta-visitantes.php'" value="   Nuevo   " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="consulta-visitantes.php?id_visitante=<?php echo $obj3->id_visitante[$i]; ?>">
          <img src="../images/icon-search.png" width="16" height="16" /></a>
          <a href="edicion-visitantes.php?id_visitante=<?php echo $obj3->id_visitante[$i]; ?>">
          <img src="../images/icon-edit.png" width="16" height="16" /></a>
          <a href="baja-visitantes.php?id_visitante=<?php echo $obj3->id_visitante[$i]; ?>">
        ...
        <tr class="textoTitulos4">
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td align="center"><input type="button" onclick="location.href='excel-visitantes.php'" value=" Exportar Excel " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
