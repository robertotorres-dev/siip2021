    ...
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Reporte de participaci&oacute;n de alumnos en eventos</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
	      ...
	      {
                printf( "<option value='reporte-participacion-alumnos.php?id_ciclo=%d' selected='selected'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
	      else
	      {
                printf( "<option value='reporte-participacion-alumnos.php?id_ciclo=%d'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
            }
	  ?>
          </select>
	  ...
	  $max = count( $obj4->id_alumno );
	    ...
	    $obj6 = new CVU_Alumnos( );
            $obj6->id_alumno = $obj4->id_alumno[$i];
            $obj6->listaCVUAlumno2( );
	?>
        <tr class="textoTablas2">
          ...
          <td align="center">
        <?php
	    if( count( $obj6->id_cvu_alumno )==0 )
	    {
	      printf( "---" );
	    }
	    else
	    {
	      printf( "<a href='reporte-participacion-alumnos2.php?id_alumno=%d'><img src='../images/icon-search.png' width='16' height='16' /></a>", $obj4->id_alumno[$i] );
	    }
	?>
          </td>
        </tr>
