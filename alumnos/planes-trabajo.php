  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Planes de trabajo</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	  ...
	  <?php echo $obj2->apellido_paterno." ".$obj2->apellido_materno." ".$obj2->nombre; ?>
        ...
        <form id="form1" name="form1" method="post" action="planes-trabajo2.php" enctype="multipart/form-data">
        <tr class="textoTablas1">
        ...
        <tr class="textoTitulos3">
          <td>Objetivos &bull;</td>
          <td colspan="3">Metas &bull;</td>
        </tr>
        <tr class="textoTitulos4">
	  ...
	  ?>
          ...
          <td valign="top">
            <table border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td>
                <form id="form2" name="form2" method="get" action="planes-trabajo.php">
                ...
                <td>&nbsp;</td>
                <td>
                <form id="form3" name="form3" method="post" action="planes-trabajo3.php" onclick="return confirmarBaja( )">
	...
	?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td align="center"><input type="button" onclick="location.href='excel-planes-trabajo.php?id_alumno=<?php echo $_GET["id_alumno"]; ?>'" value=" Exportar Excel " /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
