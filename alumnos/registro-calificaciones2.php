...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <form id="form1" name="form1" method="post" action="registro-calificaciones3.php">
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos1">
          <td colspan="6">M&oacute;dulo Alumnos</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos2">
          <td colspan="6">Registro de calificaciones</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTablas1">
          <td colspan="6">DATOS DE LA CLASE</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos3">
          ...
          <td colspan="4">Ciclo escolar:</td>
        </tr>
        <tr class="textoTitulos4">
          <td colspan="2"><?php echo $obj3->nombre; ?>&nbsp;</td>
          <td colspan="4"><?php echo $obj4->nombre; ?>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          ...
          <td colspan="4"><?php echo $obj6->apellido_paterno." ".$obj6->apellido_materno." ".$obj6->nombre; ?>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
          ...
          <td colspan="4"><?php echo $obj2->nrc; ?>&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTablas1">
          <td colspan="6">DATOS DE EVALUACI&Oacute;N</td>
        </tr>       
        <tr class="textoTablas1">
          <td>C&Oacute;DIGO</td>
          <td>NOMBRE</td>
	...
	?>
        <tr class="textoTablas2">
          ...
          <td><input type="number" name="calificacion_ordinario[<?php echo $i; ?>]" size="10" maxlength="3" min="0" max="100" value="<?php echo $obj8->calificacion_ordinario[$i]; ?>" /></td>
          <td>
	  <?php
            if( $obj8->fecha_ordinario[$i]!="0000-00-00" )
            {
              echo $obj8->fecha_ordinario[$i];
	    }
	  ?>
          &nbsp;
	  </td>
          <td><input type="number" name="calificacion_extraordinario[<?php echo $i; ?>]" size="10" maxlength="3" min="0" max="100" value="<?php echo $obj8->calificacion_extraordinario[$i]; ?>" /></td>
          <td>
	  <?php
            if( $obj8->fecha_extraordinario[$i]!="0000-00-00" )
            {
              echo $obj8->fecha_extraordinario[$i];
	    }
	  ?>
	  &nbsp;
          </td>
