  ...
  <tr height="100%" valign="top">
    <td>
	  ...
	  <?php echo $obj2->apellido_paterno." ".$obj2->apellido_materno." ".$obj2->nombre; ?>
        ...
        <form id="form1" name="form1" method="post" action="intercambios-alumnos2.php" enctype="multipart/form-data">
        <tr class="textoTablas1">
          <td colspan="4">DATOS INTERCAMBIOS</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	  ...
	  ?>
          ...
          <td valign="top">
            <table border="0" cellspacing="0" cellpadding="0" align="center">
              <tr>
                <td>
                <form id="form2" name="form2" method="get" action="intercambios-alumnos.php">
                ...
                <td>&nbsp;</td>
                <td>
                <form id="form3" name="form3" method="post" action="intercambios-alumnos3.php" onclick="return confirmarBaja( )">
