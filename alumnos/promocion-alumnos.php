<?php
  ...
  $obj4->listaAlumnosCicloPromocion( );
?>
  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Promoci&oacute;n de alumnos</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
	      ...
	      {
                printf( "<option value='promocion-alumnos.php?id_ciclo=%d' selected='selected'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
	      else
	      {
                printf( "<option value='promocion-alumnos.php?id_ciclo=%d'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
            }
	  ?>
          </select>
	  ...
	  $max = count( $obj4->id_alumno );
          ...
          for( $i=0; $i<$max; $i++ )
          {
	    if( $obj4->total_creditos[$i]>=$obj2->creditos )
	    {
	...
	?>
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="promocion-alumnos2.php?id_alumno=<?php echo $obj4->id_alumno[$i]; ?>">
