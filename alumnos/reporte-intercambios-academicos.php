...
<table class="tablaExterior" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos2">
          <td colspan="4">Reporte de intercambios acad&eacute;micos</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr class="textoTitulos4">
	      ...
	      {
                printf( "<option value='reporte-intercambios-academicos.php?id_ciclo=%d' selected='selected'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
	      else
	      {
                printf( "<option value='reporte-intercambios-academicos.php?id_ciclo=%d'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
            }
	  ?>
          </select>
	...
	?>
	    ...
	    {
	      printf( "<a href='reporte-intercambios-academicos2.php?id_alumno=%d'><img src='../images/icon-search.png' width='16' height='16' /></a>", $obj4->id_alumno[$i] );
	    }
	?>
          </td>
        </tr>
