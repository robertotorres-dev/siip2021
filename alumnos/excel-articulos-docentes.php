<?php
  ...
  header( "Content-Disposition: attachment; filename=reporte-articulos-docentes.xls" );
...
<body>
  <table>
    ...
    <tr>
      <td colspan="4">Art&iacute;culos del docente</td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    ?>
    <tr>
      <td><?php echo $obj3->id_articulo_docente[$i]; ?></td>
      <td><?php echo $obj3->titulo[$i]; ?></td>
      <td><?php echo $obj3->revista[$i]; ?></td>
