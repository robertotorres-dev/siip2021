  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr>
          <td colspan="6" class="textoRojo">Proceso completado con &eacute;xito.</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
	...
	?>
        <tr class="textoTablas2">
          ...
          <td><?php echo $obj8->calificacion_ordinario[$i]; ?>&nbsp;</td>
          <td>
          <?php
	  ...
	  ?>
          ...
          <td><?php echo $obj8->calificacion_extraordinario[$i]; ?>&nbsp;</td>
          <td>
          <?php
